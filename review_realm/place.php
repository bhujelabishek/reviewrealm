...
//     $feet=mysqli_query($conn,"SELECT `bookname` from `reviews` where `email`='$userprofile' and `category`='place'");
//     $fet=mysqli_query($conn,"SELECT `reviews` from `reviews` where `email`='$userprofile' and `category`='place'");
