...
<nav>
    ...
    <div class="boxrow2">
        ...
        <div class="boxtravel"><a href="travel.php">Travel</a></div>
...
<?php
include "db.php";
$sql=mysqli_query($conn,"SELECT `username` FROM `reviewdata`");
...
if($row>0){
    for($i=1;$i<=$row;$i++){
        $rata=mysqli_fetch_assoc($sql);
        echo $rata['username'] ."<br>";
    }
}
?>  
    </td>
    ...
    <?php
include "db.php";
$sql=mysqli_query($conn,"SELECT `email` FROM `reviewdata`");
$row=mysqli_num_rows($sql);
if($row>0){
    for($i=1;$i<=$row;$i++){
        $rata=mysqli_fetch_assoc($sql);
...
?>  
        ...
        <a href="deleteusermain.php"> <button type="submit">DELETE</button></a>
...
<?php
include "db.php";
$sql=mysqli_query($conn,"SELECT `email` FROM `reviews`");
$row=mysqli_num_rows($sql);
if($row>0){
    for($i=1;$i<=$row;$i++){
        echo $i."<br>";
...
?>  
    ...
    <?php
include "db.php";
$sql=mysqli_query($conn,"SELECT `category` FROM `reviews`");
$row=mysqli_num_rows($sql);
if($row>0){
    for($i=1;$i<=$row;$i++){
        $rata=mysqli_fetch_assoc($sql);
        echo $rata['category'] ."<br>";
    }
}
?>  
    </td>
    ...
    <?php
include "db.php";
$sql=mysqli_query($conn,"SELECT `bookname` FROM `reviews`");
$row=mysqli_num_rows($sql);
if($row>0){
    for($i=1;$i<=$row;$i++){
        $rata=mysqli_fetch_assoc($sql);
        echo $rata['bookname'] ."<br>";
    }
}
?>  
    </td>
    ...
    <?php
include "db.php";
$sql=mysqli_query($conn,"SELECT `reviews` FROM `reviews`");
$row=mysqli_num_rows($sql);
if($row>0){
    for($i=1;$i<=$row;$i++){
        $rata=mysqli_fetch_assoc($sql);
        echo $rata['reviews'] ."<br>";
    }
}
?>  
    </td>
        ...
        <a href="deletereviewmain.php"> <button type="submit">DELETE</button></a>
